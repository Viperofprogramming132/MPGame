...
public class InGameLabel extends JLabel{
	...
	public void Initialise(InGame game)
	{
		...
		_VehicleLogic.set_Location(getX(), getY());
	...
	public void setStartImage() {
		...
		_VehicleSprite = _VehicleSprite.getScaledInstance(_VehicleSprite.getWidth(null) / 2, _VehicleSprite.getHeight(null) / 2, Image.SCALE_SMOOTH);
