...
public class Vehicle 
{
	...
	/**
	 * If the vehicle should be turning left
	 */
	private boolean _left = false;
	
	/**
	 * If the vehicle should be turning right
	 */
	...
	/**
	 * Sets when the player wants to turn left
	 * @param b If they wish to turn left
	 */
	...
	/**
	 * Sets when the player wants to turn right
	 * @param b If they wish to turn right
	 */
